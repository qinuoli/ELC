...
Usage Notes
Place new article text files into the article/ directory.
Run en.py to:
...
Start the web application with app.py to serve the protected articles.
Clients will decrypt the image-embedded ciphertext via front-end JavaScript to view the original content.